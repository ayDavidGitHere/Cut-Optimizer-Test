...
const hr = {
    server_error: 'PogreÅ¡ka posluÅ¾itelja',
    invalid_cut_width: 'PogreÅ¡na Å¡irina reza',
    invalid_panel_name: 'PogreÅ¡an naziv ploÄe',
    invalid_item_name: 'PogreÅ¡an naziv elementa',
    invalid_quantity: 'PogreÅ¡na koliÄina',
    invalid_height: 'PogreÅ¡na visina',
    invalid_width: 'PogreÅ¡na Å¡irina',
    duplicate_name: 'ViÅ¡estruko ime',
    no_panels_defined: 'NepostojeÄ‡e ploÄe',
    no_items_defined: 'NepostojeÄ‡i elementi',
    panel: 'PloÄa',
    item: 'Element',
    settings: 'Postavke',
    source_code: 'Izvorni kod',
    method: 'Metoda',
    cut_width: 'Å irina reza',
    minimize_initial_panel_usage: 'Optimiraj upotrebu poÄetnih ploca',
    calculate: 'IzraÄunaj',
    quantity: 'KoliÄina',
    height: 'Visina',
    width: 'Å irina',
    panel_name: 'Naziv ploÄe',
    item_name: 'Naziv elementa',
    rotate: 'Zakreni',
    add_panel: 'Dodaj ploÄu',
    add_item: 'Dodaj element',
    csv_import: 'CSV uvoz',
    csv_export: 'CSV izvoz',
    export: 'Izvoz',
    font_size: 'VeliÄina slova',
    small: 'Mala',
    medium: 'Srednja',
    large: 'Velika',
    show_names: 'PrikaÅ¾i nazive',
    show_dimensions: 'PrikaÅ¾i veliÄine',
    cut_area: 'PovrÅ¡ina reza',
    version: 'InaÄica',
    language: 'Jezik',
    ...
    selected: 'OznaÄen',
    unused: 'NekoriÅ¡ten',
    default_panel_values: 'Inicijalne vrijednosti ploÄa',
